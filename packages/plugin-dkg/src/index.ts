...
export const dkgPlugin: Plugin = {
    ...
    actions: [dkgInsert, dkgAnalyzeSentiment], // dkgAnalyzeSentiment (Add this if you want sentiment analysis)
    providers: [graphSearch],
    evaluators: [sentimentAnalysisEvaluator], // sentimentAnalysisEvaluator (Add this if you want sentiment analysis)
};
